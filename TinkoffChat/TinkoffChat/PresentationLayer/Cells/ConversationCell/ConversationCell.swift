...
class ConversationCell: UITableViewCell {
    ...
    private func setUserFullName(with rawName: String?) {
        ...
        userFullNameLabel.textColor = RootAssembly.serviceAssembly.themeHandler.getTheme().getTextColor
    }
    ...
    private func setLastMessage(with rawMessage: String?) {
        ...
        lastMessageLabel.textColor = RootAssembly.serviceAssembly.themeHandler.getTheme().getMessageTextColor
    }
    ...
    private func setLastMessageDate(with rawDate: Date?) {
        ...
        lastMessageDateLabel.textColor = RootAssembly.serviceAssembly.themeHandler.getTheme().getMessageTextColor
    }
    
    private func setCellBackground() {
        backgroundColor = RootAssembly.serviceAssembly.themeHandler.getTheme().getBackGroundColor
    }
