...
class ThemesViewController: UIViewController {
    ...
    @IBAction func classicThemeButtonPressed(_ sender: Any) {
        ...
        RootAssembly.serviceAssembly.themeHandler.applyTheme(theme: .classic)
    ...
    @IBAction func dayThemeButtonPressed(_ sender: Any) {
        ...
        RootAssembly.serviceAssembly.themeHandler.applyTheme(theme: .day)
        // themePickerDelegate?.useCurrentTheme() - uncomment for delegate use
        themeHandlerClosure?()
        applyToCurrentView()
    }
    @IBAction func nightThemeButtonPressed(_ sender: Any) {
        ...
        RootAssembly.serviceAssembly.themeHandler.applyTheme(theme: .night)
...
extension ThemesViewController {
    ...
    func outlineCurrentTheme() {
        ...
        switch RootAssembly.serviceAssembly.themeHandler.getTheme() {
        case .classic:
